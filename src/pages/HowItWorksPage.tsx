          ...
          <div className="inline-flex p-1 bg-white rounded-xl border border-gray-200 text-xs font-bold shadow-sm">
            <button
              ...
              className={`px-5 py-2.5 rounded-lg transition ${
                activeTab === 'learners' ? 'bg-emerald-700 text-white shadow' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-lg transition ${
                activeTab === 'educators' ? 'bg-emerald-700 text-white shadow' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-lg transition ${
                activeTab === 'safety' ? 'bg-emerald-700 text-white shadow' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Verification & Escrow
            </button>
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-800 flex items-center justify-center font-bold text-base">
                1
              </div>
              <h3 className="font-bold text-gray-900 text-base">Browse or Submit a Custom Request</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Rule-Based Match & Profile Inspection</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Escrow Payment via Mobile Money</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Hands-on Apprenticeship & Review</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="bg-emerald-800 p-8 rounded-3xl text-white text-center space-y-4">
            ...
            <div className="flex justify-center gap-3 pt-2">
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-white text-emerald-950 font-bold text-xs shadow"
              >
                Find a Skill
              </button>
              <button
                onClick={onOpenSkillRequest}
                className="px-6 py-2.5 rounded-xl bg-emerald-900 text-white font-bold text-xs border border-emerald-700"
              >
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Multi-Step Verification Application</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Define Your Rates & Schedule</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Accept Learner Bookings</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-3">
              ...
              <h3 className="font-bold text-gray-900 text-base">Guaranteed 90% Net Payouts</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="bg-slate-900 p-8 rounded-3xl text-white text-center space-y-4">
      ...
      {activeTab === 'safety' && (
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm space-y-6">
            <div>
              <h2 className="text-lg font-bold text-gray-900">iSkillLink Escrow & Payment Protection Architecture</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
              <div className="p-4 rounded-xl bg-emerald-50/60 border border-emerald-200 space-y-2">
                ...
                <h4 className="font-bold text-gray-900">Protected Escrow</h4>
              ...
              <div className="p-4 rounded-xl bg-emerald-50/60 border border-emerald-200 space-y-2">
                ...
                <h4 className="font-bold text-gray-900">Zero Credential Storage</h4>
                <p className="text-gray-600 leading-relaxed">
