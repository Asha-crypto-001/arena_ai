...
export const AboutPage: React.FC<AboutPageProps> = ({
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      {/* Main Narrative Card */}
      <div className="bg-white p-8 sm:p-10 rounded-3xl border border-gray-200 shadow-sm space-y-6 text-sm text-gray-700 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-100">
          <div className="space-y-2">
            ...
            <h3 className="font-bold text-gray-900 text-sm">Rigorous Verification</h3>
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-bold text-gray-900 text-sm">100% Practical Focus</h3>
            <p className="text-xs text-gray-600 leading-relaxed">
      ...
      {/* Leadership & Location */}
      <div className="bg-slate-900 text-white p-8 sm:p-10 rounded-3xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="space-y-2 max-w-xl">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Leading practical vocational advancement from Mbarara City, Western Region, across Uganda and East Africa. Contact our office via WhatsApp at <strong>+256 744 024 529</strong> / <strong>+256 772 233 621</strong>.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 shrink-0">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-100 font-bold text-xs border border-slate-700"
          >
            Teach With Us
          </button>
        </div>
